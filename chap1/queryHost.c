/*
Compiling on Linux
g++ -I /usr/local/cuda-7.5/include/ -L /usr/local/cuda-7.5/lib64 -o queryHost queryHost.c -lOpenCL
*/
#include <stdio.h>
#include <stdlib.h>
#include <alloca.h>
...
int main() {
   ...
   // We invoke the API 'clGetPlatformInfo' twice for each parameter we're trying to extract
